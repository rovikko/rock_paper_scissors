 ...
 *   @return e^n
 */
declare function exp1(n: number): number;
 ...
 */
declare function map1(value: number, start1: number, stop1: number, start2: number, stop2: number, withinBounds?: boolean): number;
